...
service cloud.firestore {
  match /databases/{database}/documents {
    ...
    match /paginas/{paginaId} {
      allow read: if true;
      allow write: if request.auth != null && request.auth.token.email == 'jeanaguiar636@gmail.com';
    }
    match /config/{docId} {
      allow read: if true;
      allow write: if request.auth != null && request.auth.token.email == 'jeanaguiar636@gmail.com';
    ...
    match /anuncios/{anuncioId} {
      ...
      allow create: if request.auth != null;
      allow update: if request.auth != null && request.auth.token.email == 'jeanaguiar636@gmail.com';
    }
